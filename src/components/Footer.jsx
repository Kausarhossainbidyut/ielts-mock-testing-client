...
const Footer = () => {
  ...
  <aside>
    ...
    <p className="text-gray-400 max-w-xs">
      ...
      detailed analytics, and expert strategies.
    </p>
  ...
  <nav>
    ...
    <Link to="/listening" className="link link-hover text-gray-400">Listening Tests</Link>
    <Link to="/reading" className="link link-hover text-gray-400">Reading Tests</Link>
    <Link to="/writing" className="link link-hover text-gray-400">Writing Practice</Link>
    <Link to="/speaking" className="link link-hover text-gray-400">Speaking Practice</Link>
  </nav>
  
  <nav>
    <h6 className="footer-title text-blue-400">Resources</h6>
    <Link to="/tips" className="link link-hover text-gray-400">Tips & Strategies</Link>
    <Link to="/resources" className="link link-hover text-gray-400">Study Materials</Link>
    <Link to="/tests" className="link link-hover text-gray-400">Mock Tests</Link>
    <a className="link link-hover text-gray-400">Band Score Guide</a>
  </nav>
